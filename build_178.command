#!/bin/bash
# 在呢+ 出包脚本（v1.97.3 + build 178）
# 178 关键修复：HealthKit 检测改用真实样本数（避开 iOS 隐私模型永远 false 的坑）
...
echo "========================================="
echo "  在呢+ 出包 v1.97.3 (build 178)"
echo "  178 修：HealthKit 检测改用真实样本数"
echo "  PATH 已注入: $(command -v flutter)"
echo "========================================="
echo ""

ZAI_VERSION_NAME=1.97.3 ZAI_BUILD_NUMBER=178 bash build_ipa.sh
